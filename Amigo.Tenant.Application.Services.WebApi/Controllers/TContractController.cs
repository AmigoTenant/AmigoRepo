...
namespace Amigo.Tenant.Application.Services.WebApi.Controllers
{
    ...
    public class ContractController : ApiController
    {
        ...
        public async Task<ResponseDTO> ChangeTerm([FromBody]ContractChangeTermRequest contractChangeTermRequest)
        {
            if (ModelState.IsValid)
            {
                return await _contractApplicationService.ChangeTermAsync(contractChangeTermRequest);
            }
            return ModelState.ToResponse();
        }
